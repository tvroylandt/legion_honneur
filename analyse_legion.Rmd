...
df_grade <- df_legion %>%
  ...
  mutate(
    image = fct_recode(
      grade,
      "data/images/legion_chevalier_barette.svg" = "Chevalier",
      "data/images/legion_officier_barette.svg" = "Officier",
      "data/images/legion_commandeur_barette.svg" = "Commandeur",
      "data/images/legion_grand_officier_barette.svg" = "Grand officier",
      "data/images/legion_grand_croix_barette.svg" = "Grand'croix"
    ),
    part = n / sum(n)
  ) %>%
...
reactable(
  ...
  columns = list(
    ...
    image = colDef(
      name = "Barette",
      cell = function(value) {
        image <- img(src = knitr::image_uri(value),
                     height = "24px")
...
reactable(
  ...
  columns = list(
    ...
    nom_complet = colDef(name = "Identité", minWidth = 60),
    ...
    motif_nomination = colDef(name = "Motif", minWidth = 60)
  ),
  striped = TRUE,
  borderless = TRUE,
  filterable = TRUE,
