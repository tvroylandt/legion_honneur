  ...
  mutate(
    motif_nomination = case_when(
      ...
      str_detect(V11, "chambre") &
        str_detect(V11, "commerce|industrie|artisan") ~ "association/syndicat/organisation professionnelle/pompier",
...
On sélectionne les colonnes et on exporte.

```{r export}
df_legion_fin <- df_legion_6 %>%
  rename(comment = V11) %>%
  select(
    nom_complet,
    sexe,
